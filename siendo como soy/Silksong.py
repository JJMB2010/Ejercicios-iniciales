import time
print("¡Buenos dias, hoy vamos a evaluar tus saberes silksonianos!")
time.sleep(3)
print("Empecemos con preguntas generales sobre las preferencias de nuestros amigos de las profundidsades:")
time.sleep(3)
res1=str(input("¿Cuantas campanas tienes que tocar para desbloquear al jefe La Última Jueza?: "))
res1=res1.lower()
point=0
if "5" in res1:
    print("¡Correcto!")
